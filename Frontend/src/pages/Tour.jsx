...
const TOUR_WORKFLOWS = [
    {
        ...
        steps: [
            ...
            'توليد الموجه (Prompt) ونسخه ولصقه مع الصور واحداً تلو الآخر لاستخدامهم في AI Studio.',
            'أخذ النص المستخرج من AI Studio وتدقيقه.',
            'الانتقال إلى قسم التنسيق (Coordination).',
            'لصق النص النهائي واختيار نوع التنسيق كـ "محاضرة".',
            'الذهاب إلى AI Studio مرة أخرى لتنسيق النص.',
            'أخذ النص الناتج ثم الانتقال إلى قسم Pandoc للتحويل النهائي.',
            'تعبئة البيانات النهائية ولصق النص المنسق ثم الضغط على "تحويل" للحصول على ملف Word (.docx).'
        ],
        capabilities: [
