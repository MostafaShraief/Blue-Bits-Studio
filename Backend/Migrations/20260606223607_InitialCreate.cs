        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxSessionsPerUser = table.Column<int>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, "2026-01-01T00:00:00.0000000Z", "Mostafa", "Shraief", "Admin@123", null, null, "Admin", "MostafaShraief" },
                    { 2, 1, "2026-01-01T00:00:00.0000000Z", "John", "Tech", "Tech@2026", null, null, "TechMember", "john_tech" },
                    { 3, 1, "2026-01-01T00:00:00.0000000Z", "Sara", "Siri", "something", null, null, "ScientificMember", "SaraSiri" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Lecture Extraction Workflow", 1, 5, "LEC_EXT" },
                    { 2, "Bank Extraction Workflow", 1, 5, "BANK_EXT" },
                    { 3, "Lecture Coordination Workflow", 1, 5, "LEC_COORD" },
                    { 4, "Bank Coordination Workflow", 1, 5, "BANK_COORD" },
                    { 5, "Pandoc Processing Workflow", 1, 5, "PANDOC" },
                    { 6, "Bank Questions Workflow", 1, 10, "BANK_QS" },
                    { 7, "Draw AI Workflow (Beta)", 1, 5, "DRAW" },
                    { 8, "Merge Workflow (Beta)", 1, 5, "MERGE" }
                });
...
END;");
        ...
        {
            migrationBuilder.Sql("DROP TRIGGER IF EXISTS \"TRG_PruneSessionData\";");
