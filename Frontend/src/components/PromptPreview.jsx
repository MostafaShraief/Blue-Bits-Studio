...
export default function PromptPreview({ text }) {
    ...
    return (
        <div className="bg-surface-card border border-border rounded-2xl p-5 max-h-[60dvh] sm:max-h-[500px] overflow-y-auto space-y-0.5 text-sm leading-relaxed font-mono">
            {lines.map((line, i) => (
